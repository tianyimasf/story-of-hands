...
router.post("/tempRegister", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    console.log("asdbyaaaaaaaaaaawa");
    try {
        // Get user input
        ...
        const user = yield user_js_1.User.create(userJson);
        // Create token
        const token = jsonwebtoken_1.default.sign({ user_id: user._id }, process.env.TOKEN_KEY, {
            expiresIn: "2h",
        });
        // save user token
        user.token = token;
